...
{{
    ...
    "relevant_packages": ["list of relevant SEOForge packages: SeedForge, GapForge, ProfitForge, SniperForge, KeyForge, ImageForge, StaticForge, GEOForge"],
...
{{
    ...
    "relevant_packages": ["list of relevant SEOForge packages"],
